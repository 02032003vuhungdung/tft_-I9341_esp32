...
// ------------------------------------------------
//<Enum !Start!>
enum {E_PG_MAIN,E_PG2,E_PG3,E_PG4,E_POP_KEYPAD_NUM};
enum {E_DRAW_LINE1,E_DRAW_LINE2,E_DRAW_LINE3,E_DRAW_LINE4
      ,E_ELEM_NUMINPUT1,E_ELEM_NUMINPUT2,E_ELEM_PROGRESS4
      ,E_ELEM_RINGGAUGE1,E_ELEM_RINGGAUGE2,E_ELEM_RINGGAUGE3
      ,E_ELEM_TEXT1,E_ELEM_TEXT10,E_ELEM_TEXT11,E_ELEM_TEXT12
      ,E_ELEM_TEXT15,E_ELEM_TEXT2,E_ELEM_TEXT3,E_ELEM_TEXT6
      ,E_ELEM_TEXT7,E_ELEM_TEXT8,E_ELEM_KEYPAD_NUM};
...
#define MAX_ELEM_PG4 8 // # Elems total on page
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemXRingGaugeCreate(&m_gui,E_ELEM_RINGGAUGE1,E_PG2,&m_sXRingGauge1,
          (gslc_tsRect){70,160,100,100},
          (char*)m_sRingText1,11,E_BUILTIN5X8);
  gslc_ElemXRingGaugeSetValRange(&m_gui, pElemRef, 0, 500);
  ...
  pElemRef = gslc_ElemXProgressCreate(&m_gui,E_ELEM_PROGRESS4,E_PG4,&m_sXBarGauge4,
    (gslc_tsRect){130,60,100,12},0,100,0,GSLC_COL_WHITE,false);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT11,E_PG4,(gslc_tsRect){20,200,87,13},
    (char*)"ADC do roi",0,E_FREESANS9);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_CYAN);
  
  // Create E_ELEM_TEXT12 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT12,E_PG4,(gslc_tsRect){20,90,118,17},
  ...
  pElemRef = gslc_ElemXRingGaugeCreate(&m_gui,E_ELEM_RINGGAUGE2,E_PG4,&m_sXRingGauge2,
          (gslc_tsRect){130,100,100,100},
          (char*)m_sRingText2,11,E_BUILTIN5X8);
  gslc_ElemXRingGaugeSetValRange(&m_gui, pElemRef, 0, 4095);
  gslc_ElemXRingGaugeSetVal(&m_gui, pElemRef, 0); // Set initial value
  m_pElemXRingGauge2 = pElemRef;

  // Create ring gauge E_ELEM_RINGGAUGE3 
  static char m_sRingText3[11] = "";
  pElemRef = gslc_ElemXRingGaugeCreate(&m_gui,E_ELEM_RINGGAUGE3,E_PG4,&m_sXRingGauge3,
          (gslc_tsRect){130,210,100,100},
